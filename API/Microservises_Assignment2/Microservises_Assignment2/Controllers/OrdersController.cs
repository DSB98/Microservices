...
using Microservises_Assignment2.Models;

namespace Microservises_Assignment2.Controllers
{
    public class OrdersController : Controller
    {
        private MicroservicesPracticeDBEntities db = new MicroservicesPracticeDBEntities();
